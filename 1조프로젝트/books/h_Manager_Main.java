...
public class h_Manager_Main extends JFrame {
	...
	public JPanel getPanel_9() {
		if (panel_9 == null) {
			panel_9 = new JPanel();
			panel_9.setPreferredSize(new Dimension(813, 540));
			panel_9.setBounds(12, 10, 813, 572);
	...
	public JPanel getPanel_10() {
		if (panel_10 == null) {
			panel_10 = new JPanel();
			panel_10.setPreferredSize(new Dimension(813, 540));
			panel_10.setBounds(12, 10, 813, 572);
		}
		return panel_10;
	}
	...
	public JPanel getPanel_11() {
		if (panel_11 == null) {
			panel_11 = new JPanel();
			panel_11.setPreferredSize(new Dimension(813, 540));
			panel_11.setBounds(12, 10, 813, 572);
