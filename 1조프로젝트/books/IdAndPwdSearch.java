			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if(! tName.getText().isEmpty() && !tEmail.getText().isEmpty()) {
						...
						if(findId == null) {
							JOptionPane.showMessageDialog(null, "¾ÆÀÌµð¸¦ Ã£À» ¼ö ¾ø½À´Ï´Ù.");
						}
						else {
			...
			btnNewButton_1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if(! tId.getText().isEmpty() && !tEmail2.getText().isEmpty()) {
						...
						if(b==false) {
							JOptionPane.showMessageDialog(null, "ºñ¹Ð¹øÈ£¸¦ Ã£À» ¼ö ¾ø½À´Ï´Ù.");
						}
						else {
							JOptionPane.showMessageDialog(null, "ºñ¹Ð¹øÈ£¸¦ ÀÌ¸ÞÀÏ·Î Àü¼ÛÇß½À´Ï´Ù.");
						}
					}else {
						JOptionPane.showMessageDialog(null, "°ø¹é¾øÀÌ ÀÔ·ÂÇÏ¼¼¿ä");
					}
